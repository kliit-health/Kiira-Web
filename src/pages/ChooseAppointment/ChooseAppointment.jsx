...
const ChooseAppointment = () => {
  const { id } = useParams();
  console.log('🚀 ~ file: ChooseAppointment.jsx:17 ~ ChooseAppointment ~ id:', id);
  ...
  return (
    <MainLayout>
      <ContentContainer
        ...
        <ContentContainer className="w-full -mt-4 bg-kiiraBg2 border border-[#E4E7F3] rounded-lg">
          <Breadcrumbs
            ...
            <AppNavLink to="#" className="opacity-75 text-xs font-medium">
              Choose Appointment
            </AppNavLink>
          </Breadcrumbs>
        </ContentContainer>
